...
Route::middleware(['auth'])->group(function(){
    ...
    Route::get('tempat-wisata/{kegiatan_id}/kegiatan/create','KegiatanController@create')->name('admin.tempat_wisata.kegiatan.create');
    Route::get('tempat-wisata/{kegiatan_id}/kegiatan/{id}/edit','KegiatanController@index')->name('admin.tempat_wisata.kegiatan.edit');
    ...
    Route::get('tempat-wisata/{kegiatan_id}/foto','FotoController@index')->name('admin.tempat_wisata.foto.index');
    Route::get('tempat-wisata/{kegiatan_id}/foto/create','FotoController@create')->name('admin.tempat_wisata.foto.create');
    Route::get('tempat-wisata/{kegiatan_id}/foto/{id}/edit','FotoController@index')->name('admin.tempat_wisata.foto.edit');
    ...
    Route::get('tempat-wisata/{kegiatan_id}/video','VideoController@index')->name('admin.tempat_wisata.video.index');
    Route::get('tempat-wisata/{kegiatan_id}/video/create','VideoController@create')->name('admin.tempat_wisata.video.create');
    Route::get('tempat-wisata/{kegiatan_id}/video/{id}/edit','VideoController@index')->name('admin.tempat_wisata.video.edit');
